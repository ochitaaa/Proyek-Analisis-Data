...
def load_data():
    df = pd.read_csv('air quality.csv', index_col=0, parse_dates=True)
...
with tab1:
    ...
    axes[0, 1].set_xlabel('Hour', fontsize=9)
    ...
    axes[1, 0].set_xticklabels(['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], rotation=45, fontsize=8)
